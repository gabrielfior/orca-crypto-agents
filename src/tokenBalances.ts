...
async function main() {
    ...
    //const conn = new web3.Connection("http://localhost:8899");
    ...
    for (const token of [usdc]){
        ...
        await spl_token.mintTo(provider.connection, keypair, usdc.mint, ata.address, provider.wallet.publicKey, amount);
